            ...
            <div class="card rounded-0 card-outline card-navy shadow">
                <div class="card-body rounded-0">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="fullname" name="fullname" required placeholder="Ingresa tu nombre">
                                <small class="px-3 text-muted">Nombre Completo</small>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="contact" name="contact" required placeholder="N de Contacto">
                                <small class="px-3 text-muted">N Contacto</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="email" class="form-control form-control-sm form-control-border" id="email" name="email" required placeholder="correo">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-primary rounded-pill col-5">Envía mensaje</button>
                            </div>
                        </div>
                    </form>
                </div>
