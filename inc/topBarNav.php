  ...
  <div class="d-flex justify-content-between w-100">
    ...
    <div>
      <?php if ($_settings->userdata('id') > 0) : ?>
        ...
        <span class="mx-2">Estimad@, <?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('email') ?></span>
        ...
        <?php endif; ?>
      <?php else : ?>
        <a href="./admin" class="mx-2 text-dark">Acceso Administrativo</a>
      <?php endif; ?>
    </div>
  </div>
</nav>
<nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-gradient-purple" id='top-Nav'>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="./?page=appointment" class="nav-link <?= isset($page) && $page == 'appointment' ? "active" : "" ?>">Citas</a>
        </li>
        <li class="nav-item">
