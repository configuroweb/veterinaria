...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("Agregar Servicio", "services/manage_service.php", 'mid-large')
		})
		$('.edit_data').click(function() {
			uni_modal("Actualizar Servicio", "services/manage_service.php?id=" + $(this).attr('data-id'), 'mid-large')
		})
		$('.delete_data').click(function() {
			_conf("Deseas eliminar este servicio permanentemente?", "delete_service", [$(this).attr('data-id')])
		})
		$('.view_data').click(function() {
			uni_modal("Servicio", "services/view_service.php?id=" + $(this).attr('data-id'), 'mid-large')
		})
