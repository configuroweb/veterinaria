...
<div class="container-fluid">
    <form action="" id="service-form">
        ...
        <div class="form-group">
            <label for="name" class="control-label">Servicio</label>
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Ingresa Servicio" value="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="category_ids" class="control-label">Categoría <small><em>(Pet Types)</em></small></label>
        ...
        <div class="form-group">
            ...
            <input type="number" step="any" name="fee" id="fee" class="form-control form-control-border text-right" placeholder="Ingrese tarifa" value="<?php echo isset($fee) ? $fee : 0 ?>" required>
        </div>
    </form>
</div>
<script>
