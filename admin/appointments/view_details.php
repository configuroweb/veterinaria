...
<div class="content py-3">
    <div class="card card-outline card-dark rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title text-primary">Información de la Cita</h5>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <div id="outprint">
                    <fieldset>
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-bordered border-info">
                                    ...
                                    <tr>
                                        <th class="text-muted text-white bg-gradient-dark px-2 py-1">Código de la Cita</th>
                                        <td><?= ($code) ?></td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset>
                                    <legend class="text-muted border-bottom">Información del dueño</legend>
                                    <table class="table table-stripped table-bordered" data-placeholder='true' id="">
                                        ...
                                        <tbody>
                                            <tr class="border-info">
                                                <th class="py-1 px-2 text-light bg-gradient-info">Nombre</th>
                                                <td class="py-1 px-2 text-right"><?= ucwords($owner_name) ?></td>
                                            </tr>
                                            <tr class="border-info">
                                                <th class="py-1 px-2 text-light bg-gradient-info">N Contacto</th>
                                                <td class="py-1 px-2 text-right"><?= ($contact) ?></td>
                                            </tr>
                                            <tr class="border-info">
                                                <th class="py-1 px-2 text-light bg-gradient-info">Correo</th>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    <legend class="text-muted border-bottom">Información de la Mascota</legend>
                                    <table class="table table-stripped table-bordered" data-placeholder='true'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-info">
                                                <th class="py-1 px-2 text-light bg-gradient-info">Raza</th>
                                            ...
                                            <tr class="border-info">
                                                <th class="py-1 px-2 text-light bg-gradient-info">Servicios Solicitados</th>
                ...
                <div class="rounded-0 text-center mt-3">
                    <a class="btn btn-sm btn-primary btn-flat" href="javascript:void(0)" id="update_status"><i class="fa fa-edit"></i> Actualizar Estado</a>
                    <button class="btn btn-sm btn-danger btn-flat" type="button" id="delete_data"><i class="fa fa-trash"></i> Eliminar</button>
                    <a class="btn btn-light border btn-flat btn-sm" href="./?page=appointments"><i class="fa fa-angle-left"></i> Volver</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(function() {
        $('#delete_data').click(function() {
            _conf("Deseas elimina <b><?= $code ?>\'s</b> esta cita permanentemente?", "delete_appointment", ['<?= $id ?>'])
        })
        $('#update_status').click(function() {
            uni_modal("Actualizar estado", "appointments/update_status.php?id=<?= $id ?>&status=<?= $status ?>")
        })
    })
