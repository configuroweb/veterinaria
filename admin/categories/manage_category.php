...
<div class="container-fluid">
    <form action="" id="category-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Ingresa nombre de categoría" value="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
    </form>
</div>
<script>
